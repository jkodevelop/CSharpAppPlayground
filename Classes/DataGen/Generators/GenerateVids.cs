...
namespace CSharpAppPlayground.Classes.DataGen.Generators
{
    public class GenerateVids : IDataGenerator<Vids>
    {
        ...
        public List<Vids> GenerateData(int count)
        {
            if (count <= 1000)
        ...
        protected List<Vids> SingleThread(int count)
        {
            RandomDataGenerator randomGen = new RandomDataGenerator();
            Random rand = new Random();

            List<Vids> dataList = new List<Vids>();
