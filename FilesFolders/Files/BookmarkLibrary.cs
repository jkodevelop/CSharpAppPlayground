...
namespace CSharpAppPlayground.FilesFolders.Files
{
    public class LinkBookmark
    {
        ...
        public DateTimeOffset? AddDate { get; set; } // add_date - use string instead since its all UNIXTIMESECONDS
        public string ModifiedDateUnixTimeSeconds { get; set; }
        public DateTimeOffset? ModifiedDate { get; set; } // last_modified
    }
